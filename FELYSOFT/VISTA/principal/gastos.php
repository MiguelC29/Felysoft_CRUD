                    ...
                    <div class="container-fluid d-grid gap-3 align-items-center"
                        ...
                        <div class="d-flex align-items-center">
                            <form action="<?=$_SERVER['PHP_SELF']?>" class="w-100 me-3" role="search" method="post">
                                <input id="buscar" name="buscar" type="search" class="form-control" placeholder="Buscar servicios..." aria-label="Search">
                            </form>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?php echo "<a type= 'button' href='../../CONTROLADOR/updateGastos.php?pkIdGasto=".$row['pkIdGasto']." 'class='btn btn-success me-3'> Editar </a>" ?> 
